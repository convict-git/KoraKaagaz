...
public class InternetCommunicator implements ICommunicator {
    ...
    /**
     * ContentReceiveQueueListener that will be listening on the Content Receive
     * Queue
     */
    ...
    /**
     * Receive Queue in which we have the messages that needs to be sent to the
     * processing module
     */
    ...
    /**
     * Hashmap contains the handlers for the respective modules processing and
     * content
     */
     ...
     */
    public InternetCommunicator(int id) {
        clientId = id;
    ...
    /**
     * This method is used for initializing the queues, starting worker threads of
     * sendQueueListener, socketListener, processingReceiveQueueListener and
     * contentReceiveQueueListener
     */
    @Override
    public void start() {
        if (!getStatus()) {
            ...
            /**
             * Initializing the queues required for the networking module Send Queue - 1
             * with OutgoingPacket object in it. Receive queue - 2 (processing and content)
             * with IncomingPacket objects in it.
             */
             ...
             * packet sent by the sendQueueListener This listener will distingush between
             ...
             * processing modules message It will send the message which is pushed by
             * network listener through the processing module handler
             */
             ...
             * modules message It will send the message which is pushed by network listener
             * through the content module handler
             */
    ...
    /**
     * This method will help to terminate all the threads initialized in the start
     * method by setting isRunning to false and also changing all the instances to
     * null
     */
    @Override
    public void stop() {
    ...
    /**
     * This method creates a object with the params and enqueues this object into
     * the sendQueue
     * 
    ...
    public void send(String destination, String message, String identifier) {
        ...
        /**
         * Creating the object for the outgoing packet that is being pushed into the
         * send queue.
         */
    ...
    /**
     * This method used to implement Publisher-Subscriber pattern. This method takes
     * two arguments Identifier and handler. Based on the Identifier, the provided
     * handler gets the data accordingly. The handler is the object of the class
     * which implements INotificationHandler interface. Upon receiving the message
     * through network, the networking module transfers the received message to
     * subscribed module by invoking the onMessageReceived method of the provided
     * handler object.
     *
    ...
    public void subscribeForNotifications(String identifier, INotificationHandler handler) {
        ...
        /** validating the identifier */
            ...
            /**
             * logging the info as the handler might be overridden if the specified
             * identifier exists
             */
